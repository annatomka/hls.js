...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./src/polyfills/number */ "./src/polyfills/number.ts");
...
var AbrController = /*#__PURE__*/function () {
  ...
  _proto.onFragLoaded = function onFragLoaded(event, _ref) {
    ...
    if (frag.type === _types_loader__WEBPACK_IMPORTED_MODULE_5__["PlaylistLevelType"].MAIN && Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(frag.sn)) {
      var stats = part ? part.stats : frag.stats;
    ...
    if (renditionReports) {
      for (var i = 0; i < renditionReports.length; i++) {
        ...
        if (uri === playlistUri.slice(-uri.length)) {
          ...
          if (Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(msn)) {
            return new _types_level__WEBPACK_IMPORTED_MODULE_1__["HlsUrlParameters"](msn, Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(part) ? part : undefined, _types_level__WEBPACK_IMPORTED_MODULE_1__["HlsSkip"].No);
          }
        }
      }
    }
...
var BaseStreamController = /*#__PURE__*/function (_TaskLoop) {
  ...
  _proto.onMediaSeeking = function onMediaSeeking() {
    ...
    this.log("media seeking to " + (Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(currentTime) ? currentTime.toFixed(3) : currentTime) + ", state: " + state);
  ...
  _proto._doFragLoad = function _doFragLoad(frag, details, targetBufferTime, progressCallback) {
    ...
    if (Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(frag.sn) && !this.bitrateTest) {
  ...
  _proto.getFwdBufferInfo = function getFwdBufferInfo(bufferable, type) {
    ...
    if (!Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(pos)) {
      return null;
    }
  ...
  */
  ...
  _proto.alignPlaylists = function alignPlaylists(details, previousDetails) {
    ...
    var aligned = details.alignedSliding && Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(slidingStart);
  ...
  _proto.setStartPosition = function setStartPosition(details, sliding) {
    ...
    if (startPosition === -1 || this.lastCurrentTime === -1) {
      ...
      if (Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(startTimeOffset)) {
...
var BufferController = /*#__PURE__*/function () {
  ...
  _proto.flushBackBuffer = function flushBackBuffer() {
    ...
    if (!Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(backBufferLength) || backBufferLength < 0) {
      return;
    }
  ...
  _proto.updateMediaElementDuration = function updateMediaElementDuration() {
    ...
    var msDuration = Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(mediaSource.duration) ? mediaSource.duration : 0;
    ...
    } else if (levelDuration > msDuration && levelDuration > mediaDuration || !Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(mediaDuration)) {
  ...
  _proto.removeExecutor = function removeExecutor(type, startOffset, endOffset) {
    ...
    var mediaDuration = Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(media.duration) ? media.duration : Infinity;
    var msDuration = Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(mediaSource.duration) ? mediaSource.duration : Infinity;
...
function findFragmentByPDT(fragments, PDTValue, maxFragLookUpTolerance) {
  if (PDTValue === null || !Array.isArray(fragments) || !fragments.length || !Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(PDTValue)) {
    return null;
  } // if less than start
...
var ID3TrackController = /*#__PURE__*/function () {
  ...
  _proto.onLevelUpdated = function onLevelUpdated(event, _ref2) {
    ...
    if (ids.length === 0 || !Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(lastFragment === null || lastFragment === void 0 ? void 0 : lastFragment.programDateTime)) {
      return;
    }
...
function updateFromToPTS(fragFrom, fragTo) {
  ...
  if (Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(fragToPTS)) {
...
function updateFragPTSDTS(details, frag, startPTS, endPTS, startDTS, endDTS) {
  ...
  if (Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(fragStartPts)) {
    // delta PTS between audio and video
    var deltaPTS = Math.abs(fragStartPts - startPTS);

    if (!Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(frag.deltaPTS)) {
...
function mergeDetails(oldDetails, newDetails) {
  ...
  mapFragmentIntersection(oldDetails, newDetails, function (oldFrag, newFrag) {
    ...
    if (Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(oldFrag.startPTS) && Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(oldFrag.endPTS)) {
...
var StreamController = /*#__PURE__*/function (_BaseStreamController) {
  ...
  */
  ...
  _proto.onMediaSeeked = function onMediaSeeked() {
    ...
    if (Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(currentTime)) {
  ...
  _proto._handleTransmuxComplete = function _handleTransmuxComplete(transmuxResult) {
    ...
    if (initSegment) {
      ...
      if (Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(initPTS)) {
  ...
  _createClass(StreamController, [{
    ...
    get: function get() {
      ...
      if (media) {
        ...
        if (frag && Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(currentTime) && Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(frag.programDateTime)) {
...
var initPTSFn = function initPTSFn(timestamp, timeOffset) {
  return Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(timestamp) ? timestamp * 90 : timeOffset * 90000;
};
      ...
      if (emsgs) {
        emsgs.forEach(function (data) {
          ...
          if (emsgSchemePattern.test(emsgInfo.schemeIdUri)) {
            var pts = Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(emsgInfo.presentationTime) ? emsgInfo.presentationTime / emsgInfo.timeScale : timeOffset + emsgInfo.presentationTimeDelta / emsgInfo.timeScale;
...
var DateRange = /*#__PURE__*/function () {
  function DateRange(dateRangeAttr, dateRangeWithSameId) {
    ...
    if (DateRangeAttribute.END_DATE in this.attr) {
      ...
      if (Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(endDate.getTime())) {
  ...
  _createClass(DateRange, [{
    ...
    get: function get() {
      if (DateRangeAttribute.DURATION in this.attr) {
        ...
        if (Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(duration)) {
          return duration;
        }
    ...
    key: "isValid",
    get: function get() {
      return !!this.id && !this._badValueForSameId && Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(this.startDate.getTime()) && (this.duration === null || this.duration >= 0) && (!this.endOnNext || !!this.class);
    }
  }]);
...
function createLoaderContext(frag, part) {
  ...
  if (Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(start) && Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(end)) {
...
var Fragment = /*#__PURE__*/function (_BaseSegment) {
  ...
  _createClass(Fragment, [{
    ...
    get: function get() {
      ...
      if (!Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(this.programDateTime)) {
        return null;
      }

      var duration = !Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(this.duration) ? 0 : this.duration;
  ...
  _createClass(LevelDetails, [{
    ...
    get: function get() {
      if (this.fragments.length) {
        return Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(this.fragments[this.fragments.length - 1].programDateTime);
      }
  ...
  M3U8Parser.parseLevelPlaylist = function parseLevelPlaylist(string, baseurl, id, type, levelUrlId) {
    ...
    while ((result = LEVEL_PLAYLIST_REGEX_FAST.exec(string)) !== null) {
      ...
      if (duration) {
        ...
        // url
        if (Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(frag.duration)) {
          frag.start = totalduration;
          ...
          case 'SKIP':
            {
              ...
              if (Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(skippedSegments)) {
...
function assignProgramDateTime(frag, prevFrag) {
  ...
  if (!Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(frag.programDateTime)) {
...
var PlaylistLoader = /*#__PURE__*/function () {
  ...
  _proto.handleTrackOrLevelPlaylist = function handleTrackOrLevelPlaylist(response, stats, context, networkDetails) {
    ...
    var id = context.id,
        ...
        type = context.type;
    var url = getResponseUrl(response, context);
    var levelUrlId = Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(id) ? id : 0;
    var levelId = Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(level) ? level : levelUrlId;
...
var MP4Remuxer = /*#__PURE__*/function () {
  ...
  _proto.generateIS = function generateIS(audioTrack, videoTrack, timeOffset) {
    ...
    var tracks = {};
    var computePTSDTS = !Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(this._initPTS);
...
var PassThroughRemuxer = /*#__PURE__*/function () {
  ...
  _proto.remux = function remux(audioTrack, videoTrack, id3Track, textTrack, timeOffset) {
    ...
    if (!Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(lastEndDTS)) {
...
function alignDiscontinuities(lastFrag, details, lastLevel) {
  if (shouldAlignOnDiscontinuities(lastFrag, lastLevel, details)) {
    ...
    if (referenceFrag && Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(referenceFrag.start)) {
...
function alignPDT(details, lastDetails) {
  ...
  if (sliding && Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(sliding)) {
...
var FetchLoader = /*#__PURE__*/function () {
  ...
  _proto.load = function load(context, config, callbacks) {
    ...
    self.fetch(this.request).then(function (response) {
      ...
      if (onProgress && Object(_Users_annatomka_Code_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(config.highWaterMark)) {
